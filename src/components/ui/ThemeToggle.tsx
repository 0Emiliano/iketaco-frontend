...
export default function ThemeToggle({ background }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      style={{ background: background ?? 'var(--border-color)' }}
    >
      {isDark ? (
        /* Sun icon */
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" style={{ color: background ? '#ffffff' : 'var(--text-primary)' }}>
